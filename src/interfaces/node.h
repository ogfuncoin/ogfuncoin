...
#ifndef OGFUNCOIN_INTERFACES_NODE_H
#define OGFUNCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a ogfuncoin node (ogfuncoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // OGFUNCOIN_INTERFACES_NODE_H
