...
static void SetupogfuncoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ogfuncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ogfuncoin-tx [options] <hex-tx> [commands]  Update hex-encoded ogfuncoin transaction\n" +
            "or:     ogfuncoin-tx [options] -create [commands]   Create hex-encoded ogfuncoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ogfuncoin transaction
