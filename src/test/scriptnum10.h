...
#ifndef OGFUNCOIN_TEST_SCRIPTNUM10_H
#define OGFUNCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ogfuncoin Core 0.10.0, for cross-comparison.
 */
public:
