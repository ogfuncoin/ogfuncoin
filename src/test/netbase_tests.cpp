...
{
    BOOST_CHECK(TestSplitHost("www.ogfuncoincore.org", "www.ogfuncoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ogfuncoincore.org]", "www.ogfuncoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.ogfuncoincore.org:80", "www.ogfuncoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ogfuncoincore.org]:80", "www.ogfuncoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:29804", "127.0.0.1", 29804));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:29804", "127.0.0.1", 29804));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:29804", "::ffff:127.0.0.1", 29804));
    BOOST_CHECK(TestSplitHost("[::]:29804", "::", 29804));
    BOOST_CHECK(TestSplitHost("::29804", "::29804", -1));
    BOOST_CHECK(TestSplitHost(":29804", "", 29804));
    BOOST_CHECK(TestSplitHost("[]:29804", "", 29804));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:29804", "127.0.0.1:29804"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:29804", "[::]:29804"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
