...
#ifndef OGFUNCOIN_KEYSTORE_H
#define OGFUNCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/ogfuncoin/bips/blob/master/bip-0013.mediawiki
