...
#ifndef OGFUNCOIN_WALLET_WALLET_H
#define OGFUNCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this ogfuncoin node, and set to 0 for transactions that were created
...
#endif // OGFUNCOIN_WALLET_WALLET_H
