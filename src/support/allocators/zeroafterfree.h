...
#ifndef OGFUNCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define OGFUNCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // OGFUNCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
