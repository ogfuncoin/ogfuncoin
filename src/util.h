 ...
 */
#ifndef OGFUNCOIN_UTIL_H
#define OGFUNCOIN_UTIL_H
...
extern const char * const OGFUNCOIN_CONF_FILENAME;
extern const char * const OGFUNCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("ogfuncoin-%s", name);
