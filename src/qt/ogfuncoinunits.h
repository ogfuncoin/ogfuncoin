...
#ifndef OGFUNCOIN_QT_OGFUNCOINUNITS_H
#define OGFUNCOIN_QT_OGFUNCOINUNITS_H
...
/** ogfuncoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ogfuncoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ogfuncoinUnits(QObject *parent);

    /** ogfuncoin units.
      @note Source: https://en.ogfuncoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        OGFC,
...
typedef ogfuncoinUnits::Unit ogfuncoinUnit;

#endif // OGFUNCOIN_QT_OGFUNCOINUNITS_H
