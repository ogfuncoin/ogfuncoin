    ...
    mapper(0)
{
    ...
    ui->ogfuncoinAtStartup->setToolTip(ui->ogfuncoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->ogfuncoinAtStartup->setText(ui->ogfuncoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openogfuncoinConfButton->setToolTip(ui->openogfuncoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ogfuncoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ogfuncoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openogfuncoinConfButton_clicked()
{
