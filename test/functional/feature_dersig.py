...
class BIP66Test(ogfuncoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # ogfuncoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and ogfuncoind produces more specific reject
            # reasons.
