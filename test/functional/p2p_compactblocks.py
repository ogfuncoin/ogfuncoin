...
# TestP2PConn: A peer we use to send messages to ogfuncoind, and store responses.
...
class CompactBlocksTest(ogfuncoinTestFramework):
    ...
    # This test actually causes ogfuncoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ogfuncoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ogfuncoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ogfuncoind will not send blocktxn responses for blocks whose height is
