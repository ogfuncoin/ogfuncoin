...
class WalletTest(ogfuncoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 OGFC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 ogfc in block rewards plus fees, but
        ...
        # Send 10 OGFC with subtract fee from amount
        ...
        # Sendmany 10 OGFC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/ogfuncoin/ogfuncoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
