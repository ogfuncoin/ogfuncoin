...
"""Verify that starting ogfuncoin with -h works as expected."""

from test_framework.test_framework import ogfuncoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ogfuncoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ogfuncoin with -h for help text")
        ...
        self.log.info("Start ogfuncoin with -version for version information")
        ...
        self.log.info("Start ogfuncoind with -fakearg to make sure it does not start")
