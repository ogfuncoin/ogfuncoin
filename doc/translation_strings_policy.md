...
This document provides guidelines for internationalization of the ogfuncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ogfuncoin_en.ts` remains unchanged.
